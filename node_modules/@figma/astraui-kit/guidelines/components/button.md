...
Use Button for all interactive actions — form submissions, navigation triggers, and commands. Always use the `Button` component from `@figma/astraui`, never a raw `<button>` element.
